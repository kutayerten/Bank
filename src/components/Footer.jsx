...
const Footer = () =>  (
    <seciton className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        
        <div className="flex-1 flex flex-col justify-start mr-10 ">
          <img src='/src/assets/logo-2.png' alt="ktybank" className="w-[266px] h-[72px] object-contain" />
      ...
      flex-col pt-6 border-t-[1px] border-t-[#3f3r45]">
        ...
        2022 kTyBank. All rights not reserved. I don't give a shit about rights.
        </p>
